...
class Onnxruntime
{
    ...
    {
        return FFI::string(VoicevoxFFI::getInstance()->voicevox_get_onnxruntime_lib_versioned_filename());
    }
    ...
    {
        return FFI::string(VoicevoxFFI::getInstance()->voicevox_get_onnxruntime_lib_unversioned_filename());
    }
